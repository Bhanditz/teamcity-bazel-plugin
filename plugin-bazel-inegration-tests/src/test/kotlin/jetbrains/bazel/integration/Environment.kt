...
class Environment {
    companion object {
        public const val DefaultBazelVersion = "0.22.0"
        public var javaExecutable: File = File(File(System.getProperty("java.home")), File("bin", "java.exe").path)
        public var sandboxDirectory: File = File(".")
        public var samplesDirectory: File = File(".")
        public var bazelExecutable: File = File(".")
